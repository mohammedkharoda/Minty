...
null == a &&
  ...
  a('27Lyk').register(
    JSON.parse('{"f9fpV":"index.988735c7.js","eyyUD":"icons.c14567a0.svg"}')
  );
var o = (function (e) {
  var t,
    n = Object.prototype,
      ...
      (a._invoke = (function (e, t, n) {
        ...
        return function (i, a) {
          ...
          for (n.method = i, n.arg = a; ; ) {
            ...
            var c = u(e, t, n);
            if ('normal' === c.type) {
              if (((r = n.done ? f : h), c.arg === g)) continue;
  ...
  return (
    ...
    c(k, 'constructor', y),
    c(y, 'constructor', _),
    (_.displayName = c(y, s, 'GeneratorFunction')),
...
const s = async function (e, t) {
  ...
  u = function (e = c.search.page) {
    c.search.page = e;
    const t = (e - 1) * c.search.resultsPerPage,
      n = e * c.search.resultsPerPage;
    return c.search.results.slice(t, n);
  },
  d = function () {
  ...
  h = function (e) {
    c.bookmarks.push(e),
      e.id === c.recipe.id && (c.recipe.bookmarked = !0),
      d();
  };
!(function () {
  const e = localStorage.getItem('bookmarks');
  e && (c.bookmarks = JSON.parse(e));
})();
var p;
p = new URL(a('27Lyk').resolve('eyyUD'), import.meta.url).toString();
class f {
  _data;
  render(e, t = !0) {
...
function v(e, t, n, r, i) {
  const a = [2, 3, 5];
  if (!0 === i) for (let t = 3; t * t <= e; t += 2) e % t == 0 && a.push(t);
  let o = 0,
    s = 1,
    c = e,
    l = t;
...
g = function (e) {
  ...
  if ('0' == i && '0' == a) return '0';
  if (
    ((i = n.length >= 17 ? r[1].slice(0, r[1].length - 1) : r[1]),
    '99' == i && '0' !== a)
  )
    return `${a} 99/100`;
  if ('99' == i && '0' == a) return '99/100';
  if ((1 - parseFloat(`.${i}`) < 0.0011 && (i = '999'), null == i)) return a;
  let o = i
    .split('')
    .reverse()
    .join('')
    .match(/^(\d+)\1{1,2}/);
  if (o && i.length > 2) {
    let e = o[0].split('').reverse().join(''),
      n = o[1].split('').reverse().join('');
    if (n.length > 1) {
      let e = n.split(''),
        t = 1;
      for (let n = 0; n < e.length; n++) t /= e[0] / e[n];
      1 === t && (n = e[0]);
    }
    return (
      n.length > 1 &&
      ...
      (function (e, t, n, r, i) {
        const a = !0,
          o = e.length - n.length >= 1 ? e.length - n.length : 1,
          s = Math.pow(10, o),
          c = parseFloat(`0.${e}`),
          l = Math.pow(10, t.length),
          u = Math.round((c * l - c) * Math.pow(10, o));
        return v(u, (l - 1) * s, r, i, a);
      })(i, n, e, a, t)
    );
  }
  return (function (e, t, n) {
    const r = !1,
      i = parseInt(e, 10),
      a = Math.pow(10, e.length);
    return v(i, a, t, n, r);
  })(i, a, t);
};
var _ = new (class extends f {
  ...
  _generateMarkupIngredient(e) {
    return `\n    <li class="recipe__ingredient">\n      <svg class="recipe__icon">\n        <use href="${t(
      ...
      e.quantity ? t(g)(e.quantity).toString() : ''
...
var b = new (class extends f {
  _parentElement = document.querySelector('.results');
  _errorMessage = 'No recipes found for your query! Please try again ;)';
  _message = '';
  _generateMarkup() {
    return this._data.map(e => m.render(e, !1)).join('');
  }
})();
var w = new (class extends f {
...
const E = async function () {
    try {
      ...
      _.renderSpinner(),
        b.update(u()),
        k.update(c.bookmarks),
        await (async function (e) {
          try {
            const t = await s(
              `https://forkify-api.herokuapp.com/api/v2/recipes/${e}?key=3d0ae9e5-b217-4c49-b81b-d05daf2e47b5`
            );
            (c.recipe = l(t)),
              c.bookmarks.some(t => t.id === e)
    ...
    try {
      ...
      await (async function (e) {
        try {
          c.search.query = e;
          const t = await s(
            `https://forkify-api.herokuapp.com/api/v2/recipes/?search=${e}&key=3d0ae9e5-b217-4c49-b81b-d05daf2e47b5`
          );
          console.log(t),
            (c.search.results = t.data.recipes.map(e => ({
              id: e.id,
              title: e.title,
  ...
  x = function (e) {
    b.render(u(e)), w.render(c.search);
  },
  S = function (e) {
    !(function (e) {
      c.recipe.ingredients.forEach(t => {
        t.quantity = (t.quantity * e) / c.recipe.servings;
      }),
        (c.recipe.servings = e);
    })(e),
      _.update(c.recipe);
  ...
  H = function () {
    c.recipe.bookmarked
      ? (function (e) {
          const t = c.bookmarks.findIndex(t => t.id === e);
          c.bookmarks.splice(t, 1),
            e === c.recipe.id && (c.recipe.bookmarked = !1),
            d();
        })(c.recipe.id)
      : h(c.recipe),
      _.update(c.recipe),
      k.render(c.bookmarks);
  },
  M = function () {
    k.render(c.bookmarks);
  },
  j = async function (e) {
    try {
        ...
        await (async function (e) {
          try {
            const t = Object.entries(e)
              ...
              r = await s(
                'https://forkify-api.herokuapp.com/api/v2/recipes/?key=3d0ae9e5-b217-4c49-b81b-d05daf2e47b5',
                n
              );
            (c.recipe = l(r)), h(c.recipe);
          } catch (e) {
            throw e;
          }
        })(e),
      ...
      console.error('💥', e), $.renderError(e.message);
    }
  };
k.addHandlerRender(M),
  _.addHandlerRender(E),
  _.addHandlerUpdateServings(S),
  _.addHandlerAddBookmark(H),
  y.addHandlerSearch(L),
  w.addHandlerClick(x),
  $.addHandlerUpload(j);
//# sourceMappingURL=index.988735c7.js.map
